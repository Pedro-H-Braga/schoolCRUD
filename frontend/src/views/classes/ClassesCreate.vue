...
const { storeClass, exceptions } = useClasses()
...
<template>
    <main>
        <div>
            <span class="mt-4 mb-4 flex justify-first self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Criação de Turma</span>
        </div>
        <div class="mt-10">
            <form @submit.prevent="submitForm" class="max-w-md mx-auto">
                ...
                <div class="relative z-0 w-full mb-5 group">
                    <input type="text" name="year" id="year" v-model="form.year" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
                ...
                <div class="relative z-0 w-full mb-5 group">
                    ...
                    <select id="schoolTerm" v-model="form.school_term" class="block py-2.5 px-0 w-full text-sm text-gray-500 bg-transparent border-0 border-b-2 border-gray-200 appearance-none dark:text-gray-400 dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer">
